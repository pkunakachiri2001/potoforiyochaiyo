...
class QuantumParticleOrbit {
  ...
  animate() {
    ...
    this.particles.forEach((el, i) => {
      ...
      el.style.background = `linear-gradient(135deg, #00ffff, #8b5cf6)`
      el.style.width = '8px'
      el.style.height = '8px'
      ...
      el.style.boxShadow = '0 0 12px #00ffff'
    })
    requestAnimationFrame(() => this.animate())
  }
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.getElementById("liveCode")) {
    new AdvancedTypingEffect("liveCode")
  }
  ...
  new NavigationScrollEffect()

  // Initialize contact form handler
  new ContactFormHandler()

  // Initialize quantum particle orbit effect
  new QuantumParticleOrbit()

  // Show AI quote on hero section
  showAIQuote()
  ...
  // Add resume download button functionality
...
>>>>>>> 1956a5d245c020eb89c42759fc96886328bc2e04
